...
### Mock-объект
**mock** - пустой объект, который эмулирует поведение некого реального объекта. Mock выдаёт тот результат, который ожидается от реального объекта при исправной работе, поэтому использование mock-объекта позволяет сэкономить время при тестировании и избежать каких-то фантомных ошибок (долгая загрузка ресурсов из интернета, прерывания интернет соединения и т.д.).
